						...
						<li>
							...
							<ul>
								<li>
									...
									with multiple facebook friends in one session. This voice chat
									will continue to exist when the user is inside an Oculus app.
									We are going to use this API to meet the real time voice chat
									communication requirement and test its usability when the user
									is running our side loaded application.
								</li>
							</ul>
						</li>
						<li>
							Utilise the hand held tracking device connected to the Oculus Go.
							<ul>
								<li>
								...
								<li>
									User should at least be able to point and select a feature on
									the UI.
								</li>
							</ul>
						</li>
			...
			<Card className="theme-bd-l-purple  mb-4">
				...
				<CardBody>
					<ol>
						...
						<li>
							Ability for the presenter to upload a presentation file for every
							attendee to see.
						</li>
					</ol>
				</CardBody>
							...
							<ul>
								...
								<li>
									...
									<ul>
										...
										<li>
											All operations must be done whilest inside the VR meeting
